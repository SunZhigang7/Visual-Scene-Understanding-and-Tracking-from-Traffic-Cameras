...
__C.YOLO.CLASSES = "multi_object_tracking/data" \
                   "/classes/coco.names"
...
__C.TRAIN.ANNOT_PATH = "multi_object_tracking/data" \
                       "/dataset/val2017.txt"
...
__C.TEST.ANNOT_PATH = "multi_object_tracking/data" \
                      "/dataset/val2017.txt"
__C.TEST.BATCH_SIZE = 2
__C.TEST.INPUT_SIZE = 416
__C.TEST.DATA_AUG = False
__C.TEST.DECTECTED_IMAGE_PATH = "multi_object_tracking/data" \
                                "/detection/"
